...
namespace ProductConfigurator.Core
{
    ...
    {
        public static Item Carbon => Item.Create("Carbon fiber", "Carbon fiber can be painted. It can also be left in an exposed carbon finish, so that the framework can be seen.Carbon look is widely used in Formula 1.", 920m, ItemType.Carbon);
        public static Item Glass => Item.Create("Glass fiber", "Fiberglass is widely used in sports equipment. The basic fibreglass case is white or black (matte or glossy).", 850m, ItemType.Fiber);
